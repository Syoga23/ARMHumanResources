object BackData: TBackData
  ...
  object EmployeesSQL: TADOQuery
    ...
    object EmployeesSQLDepartment_Nazv: TStringField
      FieldKind = fkLookup
      FieldName = 'Department_Nazv'
      LookupDataSet = DepartmentSQL
  ...
  object DepartmentSQL: TADOQuery
    ...
    Left = 208
    Top = 72
    object DepartmentSQLdepartment_id: TAutoIncField
      FieldName = 'department_id'
      ReadOnly = True
    end
    object DepartmentSQLdepartment_name: TWideStringField
      FieldName = 'department_name'
      Size = 100
    end
    object DepartmentSQLlocation_id: TIntegerField
